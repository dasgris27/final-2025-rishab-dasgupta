        ...
        <div className="relative">
            <div className="flex flex-col lg:flex-row gap-4">
                ...
                <div className="md:flex-grow">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-4 mb-12 gap-4">
                        <Card id="games-minesweeper-remake">
                            ...
                            <CardBody className="pb-0">
                                ...
                                <p>
                                    A recreation of the classic game with the
                                    same rules: reveal all of the cells as
                                    quickly as you can without exposing any
                                    mines.
                                </p>
                            </CardBody>
                            <CardFooter>
                    ...
                    <p>
                        These are websites that I made while learning web design
                        in Skyline High School.{" "}
                        <Link href="https://github.com/bbl4kney">Blakney</Link>{" "}
                        was my teacher, and he taught us how TailwindCSS works,
                        ways to use it to style elements, and how to run a live
                        server to ease the development process.
                    </p>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-4 mb-12 gap-4">
                        <Card id="design-class-may-2025-notebook-check">
                            ...
                            <CardBody className="pb-0">
                                ...
                                <p>
                                    Our class' progress in May 2025. This
                        ...
                        <Card id="design-class-march-2025-notebook-check">
                            ...
                            <CardBody className="pb-0">
                                ...
                                <p>
                                    Our class' progress in March 2025. Includes
                                    a basic About Me page, list of recipes, and
